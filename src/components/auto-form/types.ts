// import type { getCurrentPlanWithAuth } from "@/server/getCurrentPlanWithAuth";
...
export type FieldConfigItem = {
  ...
  inputProps?: React.InputHTMLAttributes<HTMLInputElement> & {
    ...
    optionsForTier?: [string, ("pro" | "business" | "enterprise")?, string?][];
...
type BaseDependency<SchemaType extends z.infer<z.ZodObject<any, any>>> = {
  ...
  type: DependencyType;
  targetField: keyof SchemaType | (keyof SchemaType)[];
