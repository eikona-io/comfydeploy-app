    ...
    >
      <Drawer.Portal>
        <Drawer.Content
          className={cn(
            isMobile
              ? "fixed right-0 bottom-0 left-0 mt-24 flex h-[96%] flex-col rounded-t-[16px] bg-white md:top-0 md:right-0 md:bottom-0 md:h-full md:w-[400px] md:rounded-l-[16px] md:rounded-tr-none dark:bg-zinc-900"
