          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              <div className="mb-4">
                ...
                <span className="mx-1 w-fit rounded-md bg-gray-100 px-2 py-1 text-gray-500 text-xs leading-snug dark:bg-zinc-700 dark:text-zinc-400">
              ...
              <div className="flex flex-col items-center gap-4 md:flex-row">
                ...
                <div className="flex w-full flex-1 justify-between rounded-[6px] border border-gray-200 bg-gray-100 p-2 md:w-auto dark:border-zinc-700 dark:bg-zinc-700/50">
                  <div className="flex flex-row items-center gap-x-4">
                    <div>
                      <CircleX className="h-4 w-4" />
                    </div>
                    <div className="flex flex-col">
                      <div className="flex flex-row items-center gap-x-2 font-medium font-mono text-gray-600 text-xs dark:text-zinc-400">
                        {currentMachineVersion?.id.slice(0, 8)}
                        <span className="w-fit rounded-md bg-gray-200 px-2 py-1 text-gray-500 text-xs leading-snug dark:bg-zinc-700 dark:text-zinc-400">
                          v{currentMachineVersion?.version}
                        </span>
                      </div>
                      <div className="flex flex-row items-center gap-x-2">
                ...
                <div className="flex w-full flex-1 justify-between rounded-[6px] border border-gray-200 bg-white p-2 shadow-lg md:w-auto dark:border-zinc-700 dark:bg-zinc-700/50">
                  <div className="flex flex-row items-center gap-x-4">
                    <div>
...
function NoChanges() {
  return (
    <div className="mt-4 flex items-center justify-center rounded-[6px] border border-gray-200 bg-gray-50 p-6 dark:border-zinc-700 dark:bg-zinc-700/50">
      <div className="flex items-center gap-2 text-gray-500 text-sm dark:text-zinc-400">
  ...
  return (
    <div className="mt-4 max-h-[500px] space-y-2 overflow-y-auto pb-3">
      {changes.map((change, index) => (
        <div
          key={index}
          className="rounded-lg border border-gray-100 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-700/50"
        >
