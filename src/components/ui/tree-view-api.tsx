...
import { File as FileIcon, FolderIcon, FolderOpenIcon } from "lucide-react";
    ...
    return (
      ...
      >
        <AccordionPrimitive.Trigger
          className={cn(
            `flex items-center justify-between gap-1 text-sm rounded-md w-full`,
            className,
            {
    ...
    return (
      <AccordionPrimitive.Item value={value} className="relative">
        <AccordionPrimitive.Trigger
          ...
          aria-label="File"
          className={cn(
            "w-full group flex items-center justify-between gap-1 cursor-pointer text-sm pr-1 rtl:pl-1 rtl:pr-0 rounded-md  duration-200 ease-in-out",
            {
        ...
        >
          <div className="flex w-full items-center gap-1 overflow-hidden relative">
            {fileIcon ?? <FileIcon className="h-4 w-4" />}
            {children}
            <div className="absolute right-0">{tail}</div>
          </div>
        </AccordionPrimitive.Trigger>
      </AccordionPrimitive.Item>
    );
