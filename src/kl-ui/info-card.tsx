...
const InfoCardMedia = ({
  ...
  return (
    ...
    >
      <motion.div
        className={cn("relative mt-2 rounded-[10px]", className)}
        animate={{
          height:
            media.length > 0
              ? isHovered
              ...
              >
                {type === "video" ? (
                  ...
                  <img
                    ...
                    alt={alt}
                    className={cn(
                      "w-full rounded-[10px] border border-gray-200 object-cover shadow-lg dark:border-zinc-700/10",
                      itemClassName,
                    )}
